...
const Registracija = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await setPoruka(res.data.message);
  ...
  return (
    <div className="auth-container">
      <div className="auth-left">
        <h1>Učlanite se danas</h1>
        <p>
          Registrujte se i započnite svoje sportsko putovanje već danas! Povežite se sa istomišljenicima i organizujte događaje.
        </p>
      </div>
